...
const CalmingSignal = () => {
  return (
    <div className="calming_signal_container">
      <NavConatiner />
      <Sidebar />
      <div className="calming_signal_text_box">
        <div className="about_title">Calming Signal</div>
        <div className="about_text_body">
          ...
          <div className="about_text_second">
            우리는 여자친구,남자친구가 외국이이라면 대화하기 위해서 새로운
            언어를 배울것입니다.
          </div>
          ...
          <div className="about_text_forth">
            반려견은 사람의 언어를 못한다는 이유로 소통을 할 수 없다고
            생각하기도 합니다.
          </div>
          ...
          <div className="about_text_sixth">
            반려견이 보내는 신호를 읽고 그들의 마음을 헤아려 함께 행복하게 살 수
            있도록 하는 것이
            <br />
            calming signal의 목표입니다.
          </div>
        </div>
      </div>
