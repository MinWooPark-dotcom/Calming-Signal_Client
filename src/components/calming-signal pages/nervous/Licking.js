    ...
    <div className="licking_container">
      ...
      <div className="licking_contents">
        ...
        <div className="licking_contents_right">
          ...
          <div className="licking_contents_right_first">냄새를 잘 맡기 위해서 촉촉하게 유지하는게 아닌 카밍시그널에서의 의미는 긴장이 많이 될때 코를 핥는 행동을 한답니다.</div>
          <div className="licking_contents_right_second">안정이 필요하고 불안하니 코를 핥으면서 안정을 느낀다고 해요!</div>
          <div className="licking_contents_right_third">이럴때에는 편안할 수 있도록 배려하는 마음을 갖는게 중요해요.</div>
