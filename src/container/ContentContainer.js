...
import { getComment } from '../modules/content';
...
const ContentContainer = () => {
  ...
  const contentNumOfViews = useSelector(
    (state) => state.content.contentNumOfViews
  );
  const contentCreatedAt = useSelector(
    (state) => state.content.contentCreatedAt
  );
